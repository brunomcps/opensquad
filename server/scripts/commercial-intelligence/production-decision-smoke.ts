...
try {
  ...
  if (desktopResult.overflow > 1 || desktopResult.visibleTabs !== 7) throw new Error('Production desktop navigation or horizontal layout failed.');
  ...
  if (mobileResult.overflow > 1 || mobileResult.visibleTabs !== 7) throw new Error('Production mobile navigation or horizontal layout failed.');
