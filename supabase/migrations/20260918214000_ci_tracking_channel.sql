-- Etapa 2 da faxina (18/09/2026): canal como dimensão do rastreamento.
--
-- ci_tracking_series e ci_tracking_events só olhavam as 4 posições do YouTube
-- (e o livro-caixa só o produto MAPA). Efeitos: os 186 cliques do link de
-- comentário do Instagram entravam como "Resposta a comentário" do YouTube;
-- bio e DM do Instagram não entravam em lugar nenhum; venda de outro produto
-- só aparecia se tivesse vindo por link do MAPA.
--
-- Agora: p_channel (youtube | instagram | null = todos), todas as posições,
-- e cada linha devolvida carrega o canal, pra tela separar as caixas.
