...
try {
  ...
  if (desktopResult.visibleTabs !== 8 || desktopResult.navHeight < 100) throw new Error('Navegação desktop não está totalmente visível.');
  ...
  if (mobileResult.visibleTabs !== 8 || mobileResult.navHeight < 40) throw new Error('Navegação mobile não está totalmente visível.');
